...
static void InitDefaultsscc_info_SoftIrq_cpu_5fsoftirq_2eproto() {
  ...
  ::monitor::proto::SoftIrq::InitAsDefaultInstance();
}
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_cpu_5fsoftirq_2eproto = {
  &descriptor_table_cpu_5fsoftirq_2eproto_initialized, descriptor_table_protodef_cpu_5fsoftirq_2eproto, "cpu_softirq.proto", 221,
...
SoftIrq::SoftIrq()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:monitor.proto.SoftIrq)
}
...
template<> PROTOBUF_NOINLINE ::monitor::proto::SoftIrq* Arena::CreateMaybeMessage< ::monitor::proto::SoftIrq >(Arena* arena) {
  return Arena::CreateInternal< ::monitor::proto::SoftIrq >(arena);
}
