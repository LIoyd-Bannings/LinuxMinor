...
static void InitDefaultsscc_info_MemInfo_mem_5finfo_2eproto() {
  ...
  ::monitor::proto::MemInfo::InitAsDefaultInstance();
}
...
static bool descriptor_table_mem_5finfo_2eproto_initialized = false;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_mem_5finfo_2eproto = {
  &descriptor_table_mem_5finfo_2eproto_initialized, descriptor_table_protodef_mem_5finfo_2eproto, "mem_info.proto", 427,
...
static bool dynamic_init_dummy_mem_5finfo_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_mem_5finfo_2eproto), true);
namespace monitor {
namespace proto {
...
MemInfo::MemInfo()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:monitor.proto.MemInfo)
}
...
void MemInfo::InternalSwap(MemInfo* other) {
  ...
  swap(kreclaimable_, other->kreclaimable_);
  swap(sreclaimable_, other->sreclaimable_);
  swap(sunreclaim_, other->sunreclaim_);
  swap(used_percent_, other->used_percent_);
}
...
template<> PROTOBUF_NOINLINE ::monitor::proto::MemInfo* Arena::CreateMaybeMessage< ::monitor::proto::MemInfo >(Arena* arena) {
  return Arena::CreateInternal< ::monitor::proto::MemInfo >(arena);
}
